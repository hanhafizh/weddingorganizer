    ...
    <div class="col-md-12 grid-margin">
      <div class="row">
        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
          <h3 class="font-weight-bold">Manage Catalog</h3>
        ...
        ?>
          <tr>
            ...
            <td class="text-center">
              ...
              <a class="btn btn-sm btn-danger" href="<?= base_url('admin/Katalog/delete?id=') . $row->catalogue_id; ?>" title="Hapus" onclick="if (! confirm('Apakah anda yakin akan menghapus Katalog ini?')) { return false; }">Delete</a>
            </td>
          </tr>
        <?php endforeach; ?>
