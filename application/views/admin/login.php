...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="<?= base_url('assets/landing') ?>/img/logo2.png" alt="logo" />
</head>
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3">
                ...
                <div class="mt-3">
                  <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="<?= base_url('admin/Dashboard') ?>/index.html">SIGN IN</a>
                </div>
              </form>
            </div>
          </div>
